 ...
 */
GENTICS.Aloha.Repositories.drupal = new GENTICS.Aloha.Repository('com.gentics.aloha.repositories.drupal');
 ...
 * @cfg
 */
//GENTICS.Aloha.Repositories.drupal.settings.url = 'http://localhost/drupal7/';
GENTICS.Aloha.Repositories.drupal.settings.url = '/';
...
GENTICS.Aloha.Repositories.drupal.init = function() {
	...
	this.drupalRepositoryURL = that.settings.url + "aloha-lookup.php?lookup=";
